...
public class Datastore implements org.apache.thrift.TBase<Datastore, Datastore._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Datastore other) {
    ...
    if (isSetUsableSize()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.usableSize, typedOther.usableSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
