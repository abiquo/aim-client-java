...
public class DomainInfo implements org.apache.thrift.TBase<DomainInfo, DomainInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(DomainInfo other) {
    ...
    DomainInfo typedOther = (DomainInfo)other;
    ...
    lastComparison = Boolean.valueOf(isSetNumberVirtCpu()).compareTo(typedOther.isSetNumberVirtCpu());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumberVirtCpu()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numberVirtCpu, typedOther.numberVirtCpu);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          ...
          case 3: // STATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.state = DomainState.findByValue(iprot.readI32());
