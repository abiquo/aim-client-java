...
public class LibvirtException extends TException implements org.apache.thrift.TBase<LibvirtException, LibvirtException._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(LibvirtException other) {
    ...
    LibvirtException typedOther = (LibvirtException)other;
    ...
    lastComparison = Boolean.valueOf(isSetInt1()).compareTo(typedOther.isSetInt1());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInt1()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.int1, typedOther.int1);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInt2()).compareTo(typedOther.isSetInt2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInt2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.int2, typedOther.int2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
